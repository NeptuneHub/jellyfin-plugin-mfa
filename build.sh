...
PROJECT_DIR="$SCRIPT_DIR/src/Jellyfin.Plugin.Mfa"
OUTPUT_DIR="$SCRIPT_DIR/dist/Jellyfin.Plugin.Mfa"
INSTALL_FLAG="${1:-}"
...
if [ "$INSTALL_FLAG" = "--install" ]; then
    PLUGIN_DIR="${JELLYFIN_DATA:-$HOME/.local/share/jellyfin}/plugins/Jellyfin.Plugin.Mfa"
    rm -rf "$PLUGIN_DIR"
